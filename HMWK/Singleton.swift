...
class Singleton: NSObject {
    ...
    public override init()
    {
        ...
        betResponse = Response(responseID: "004", promptID: "004", image: #imageLiteral(resourceName: "mom"), user: studentUser1, comment: "I couldn't live without my mom. She's everything to me!")
        ...
        allPrompts = [freeMarketsPrompt, elasticityPrompt, casaPrompt, betPrompt]
        allResponses = [freeMarketsResponse1, freeMarketsResponse2, casaResponse1, elasticityResponse1, betResponse]
