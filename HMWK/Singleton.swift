...
//    var betResponse: Response
    ...
    public override init()
    {
        ...
        teacherUser1 = User(aUsername: "mr_lewis", userEmail: "lewis@gmail.com", aProfileImage: #imageLiteral(resourceName: "profileimage"), aUserType: "teacherUser", aEnrolledCourses: [])
