...
class Singleton: NSObject {
    ...
    public override init()
    {
        ...
        scarcityResponse2 = Response(responseID: "007", promptID: "005", image: #imageLiteral(resourceName: "time"), user: studentUser2, comment: "There's only so much time in a day. I try to make it count!")
        scarcityResponse3 = Response(responseID: "008", promptID: "005", image: #imageLiteral(resourceName: "space"), user: studentUser3, comment: "Space is scarce in our house, so we have to put a bunch of beds in one room.")
        ...
        scarcityResponse5 = Response(responseID: "010", promptID: "005", image: #imageLiteral(resourceName: "pass"), user: studentUser3, comment: "Only 6 minutes of passing period time, yet so much to do =/")
        scarcityResponse6 = Response(responseID: "011", promptID: "005", image: #imageLiteral(resourceName: "wallet"), user: studentUser2, comment: "Money is looking scarce is my wallet right now!")
        ...
        elasticityPrompt = Prompt(promptID: "002", promptImage: #imageLiteral(resourceName: "inelastic"), promptTitle: "Inelastic", promptComment: "Capture a good or service for which you are very inelastic in your demand!", promptResponses: [elasticityResponse1])
        ...
        betPrompt = Prompt(promptID: "004", promptImage: #imageLiteral(resourceName: "cav"), promptTitle: "The Bet", promptComment: "Post one thing you couldn't live without!", promptResponses: [betResponse])
        scarcityPrompt = Prompt(promptID: "005", promptImage: #imageLiteral(resourceName: "bottle"), promptTitle: "Scarcity", promptComment: "How does scarcity impact YOU?? Find an example of you dealing with scarcity in your day-to-day activities.", promptResponses: [scarcityResponse1, scarcityResponse2, scarcityResponse3, scarcityResponse4, scarcityResponse5, scarcityResponse6])
        
        
        economicsCourse = Course(courseID: "001", coursePrompts: [freeMarketsPrompt, scarcityPrompt], courseImage: #imageLiteral(resourceName: "econ"), courseName: "Economics")
        ...
        english8Course = Course(courseID: "004", coursePrompts: [betPrompt], courseImage: #imageLiteral(resourceName: "books"), courseName: "English 8")
        ...
        allPrompts = [freeMarketsPrompt, elasticityPrompt, casaPrompt, betPrompt, scarcityPrompt]
        allResponses = [freeMarketsResponse1, freeMarketsResponse2, casaResponse1, elasticityResponse1, betResponse, scarcityResponse1, scarcityResponse2, scarcityResponse3, scarcityResponse4, scarcityResponse5, scarcityResponse6]
